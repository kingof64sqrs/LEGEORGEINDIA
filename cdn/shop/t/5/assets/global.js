    ...
    onVariantChange() {
        ...
        try {
            ...
            if (!variant ? .available) {
                document.getElementsByClassName("breezeButtonContainerClass")[0].style.pointerEvents = "none";
                document.getElementsByClassName("breezeButtonContainerClass")[0].style.opacity = 0.7
            } else {
                document.getElementsByClassName("breezeButtonContainerClass")[0].style.pointerEvents = "auto";
                document.getElementsByClassName("breezeButtonContainerClass")[0].style.opacity = 1;
            }
        } catch (e) {}
    }
